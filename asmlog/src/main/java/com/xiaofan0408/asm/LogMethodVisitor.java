...
/**
 * @author xuzefan  2019/8/12 14:12
 */
public class LogMethodVisitor extends AdviceAdapter {

    private static final String COST_ANNOTATION_DESC = "Lcom/xiaofan0408/anno/AsmLog;";
    ...
    LogMethodVisitor(int api, MethodVisitor mv, int access, String className, String methodName, String desc) {
    ...
    protected void onMethodEnter() {
        if (isInjected) {
            ...
            mv.visitMethodInsn(INVOKESTATIC, "com/xiaofan0408/core/MethodCache", "request", "()I", false);
            ...
            for (int i = 0; i < argumentArrays.length; i++) {
                ...
                visitMethodInsn(INVOKESTATIC, "com/xiaofan0408/core/MethodCache", "addMethodArgument",
    ...
    protected void onMethodExit(int opcode) {
        if (isInjected) {
            ...
            mv.visitVarInsn(ILOAD, methodId);
            mv.visitMethodInsn(INVOKESTATIC, "com/xiaofan0408/core/MethodCache", "updateMethodInfo",
                    "(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JI)V", false);

            mv.visitVarInsn(ILOAD, methodId);
            mv.visitMethodInsn(INVOKESTATIC, "com/xiaofan0408/core/MethodCache",
